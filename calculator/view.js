...
View.prototype.AddButton = function(row, value, button_value) {
  if(button_value == 'zero') {
    row.append('<div class="calcbutton zero">' + values[button_value] + '</div>');
  } else if (button_value == 'equals') {
    row.append('<div class="calcbutton equals">' + values[button_value] + '</div>');
  } else if (button_value == 'point') {
     row.append('<div class="calcbutton point">' + values[button_value] + '</div>');
  } else {
    row.append('<div class="calcbutton">' + values[button_value] + '</div>');
  }
}
